...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'Games', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\BackEnd\\Games\\GamesBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\BackEnd\\Requete\\RequeteBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\User\\UserBundle\\Entity')));
        ...
        $d->setEntityNamespaces(array('BackEndGamesGamesBundle' => 'BackEnd\\Games\\GamesBundle\\Entity', 'BackEndRequeteRequeteBundle' => 'BackEnd\\Requete\\RequeteBundle\\Entity', 'UserUserBundle' => 'User\\UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_fd690a683f3f0c35c5e1d65743fee26e828759f0dde3ea543c75f50f1bfcf70a');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('User\\UserBundle\\Entity\\Utilisateur');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('User\\UserBundle\\Entity\\Utilisateur');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('User\\UserBundle\\Entity\\Utilisateur');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('User\\UserBundle\\Entity\\Utilisateur');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('fos_user.doctrine_registry')->getManager(NULL), 'User\\UserBundle\\Entity\\Utilisateur');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\BackEnd\\Games\\GamesBundle/Resources/views'), 'BackEndGamesGames');
        $instance->addPath(($this->targetDirs[3].'\\src\\BackEnd\\Requete\\RequeteBundle/Resources/views'), 'BackEndRequeteRequete');
        $instance->addPath(($this->targetDirs[3].'\\src\\FrontEnd\\GamesBundle/Resources/views'), 'FrontEndGames');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'fos_user.model.user.class' => 'User\\UserBundle\\Entity\\Utilisateur',
