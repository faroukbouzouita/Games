...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->parameters = array(
            'kernel.root_dir' => 'C:/wamp/www/Jeux/app',
            'kernel.environment' => 'prod',
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/wamp/www/Jeux/app/cache/prod',
            'kernel.logs_dir' => 'C:/wamp/www/Jeux/app/logs',
            'kernel.bundles' => array(
                ...
                'BackEndGamesGamesBundle' => 'BackEnd\\Games\\GamesBundle\\BackEndGamesGamesBundle',
                'BackEndRequeteRequeteBundle' => 'BackEnd\\Requete\\RequeteBundle\\BackEndRequeteRequeteBundle',
                'FrontEndGamesBundle' => 'FrontEnd\\GamesBundle\\FrontEndGamesBundle',
            ),
            ...
            'session.save_path' => 'C:/wamp/www/Jeux/app/cache/prod/sessions',
            ...
            'router.resource' => 'C:/wamp/www/Jeux/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/wamp/www/Jeux/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.default.memory.path' => 'C:/wamp/www/Jeux/app/cache/prod/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/wamp/www/Jeux/app/cache/prod/assetic',
            ...
            'assetic.read_from' => 'C:/wamp/www/Jeux/app/../web',
            'assetic.write_to' => 'C:/wamp/www/Jeux/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'C:/wamp/www/Jeux/app/cache/prod/doctrine/orm/Proxies',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/wamp/www/Jeux/app/cache/prod/annotations', false);
    }
    protected function getAssetic_AssetManagerService()
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig'), $this->get('monolog.logger.assetic', ContainerInterface::NULL_ON_INVALID_REFERENCE)), new \Assetic\Cache\ConfigCache('C:/wamp/www/Jeux/app/cache/prod/assetic/config'), false)));
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'C:/wamp/www/Jeux/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
        return $instance;
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:/wamp/www/Jeux/app/Resources');
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'Games', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => (dirname(dirname(dirname(__DIR__))).'\\src\\BackEnd\\Games\\GamesBundle\\Entity'), 1 => (dirname(dirname(dirname(__DIR__))).'\\src\\BackEnd\\Requete\\RequeteBundle\\Entity')));
        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'BackEnd\\Games\\GamesBundle\\Entity');
        $c->addDriver($b, 'BackEnd\\Requete\\RequeteBundle\\Entity');
        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('BackEndGamesGamesBundle' => 'BackEnd\\Games\\GamesBundle\\Entity', 'BackEndRequeteRequeteBundle' => 'BackEnd\\Requete\\RequeteBundle\\Entity'));
        $d->setMetadataCacheImpl($this->get('doctrine_cache.providers.doctrine.orm.default_metadata_cache'));
        $d->setQueryCacheImpl($this->get('doctrine_cache.providers.doctrine.orm.default_query_cache'));
        $d->setResultCacheImpl($this->get('doctrine_cache.providers.doctrine.orm.default_result_cache'));
        $d->setMetadataDriverImpl($c);
        $d->setProxyDir('C:/wamp/www/Jeux/app/cache/prod/doctrine/orm/Proxies');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_c1ca66a3b2ca4334c0c17b06eccad032cef7d6e9be6cdbb316d092fe5fb7565e');
        return $instance;
    }
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:/wamp/www/Jeux/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('C:/wamp/www/Jeux/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/wamp/www/Jeux/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/wamp/www/Jeux/app/cache/prod/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:/wamp/www/Jeux/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => 'C:/wamp/www/Jeux/app/cache/prod/translations', 'debug' => false));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'C:/wamp/www/Jeux/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'\\src\\BackEnd\\Games\\GamesBundle/Resources/views'), 'BackEndGamesGames');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'\\src\\BackEnd\\Requete\\RequeteBundle/Resources/views'), 'BackEndRequeteRequete');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'\\src\\FrontEnd\\GamesBundle/Resources/views'), 'FrontEndGames');
        $instance->addPath('C:/wamp/www/Jeux/app/Resources/views');
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/wamp/www/Jeux/app/../web', false);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/wamp/www/Jeux/app/cache/prod');
    }
